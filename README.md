...
## Fitur Proyek
1. Generator Data: Menghasilkan data simulasi yang realistis, menirukan pola jam sibuk (peak hours), akhir pekan, kapasitas penumpang, serta status keterlambatan operasional.
2. Data Cleaning & Processing: Script ETL sederhana untuk merapikan dataset mentah menggunakan Pandas.
3. Interactive Dashboard: Dashboard interaktif yang dibangun menggunakan Streamlit dan Plotly untuk memvisualisasikan KPI utama, pola harian, jam sibuk, status operasional, serta rute terpopuler.
